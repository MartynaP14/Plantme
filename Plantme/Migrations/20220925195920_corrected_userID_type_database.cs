...
{
    public partial class corrected_userID_type_database : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UserPhoneNo = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ProdcutTypes = table.Column<int>(type: "int", nullable: false),
                    ...
                    GrowingConditions = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    PlantingInstructions = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    PetFriendly = table.Column<bool>(type: "bit", nullable: false),
                    ChildFriendly = table.Column<bool>(type: "bit", nullable: false),
                    BeginnerFriendly = table.Column<bool>(type: "bit", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    OrderSubtotal = table.Column<int>(type: "int", nullable: false),
                    ProductId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
